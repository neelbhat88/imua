...
class SchoolClassesControllerTest < ActionController::TestCase
  ...
  test "should create school_class" do
    assert_difference('SchoolClass.count') do
      post :create, school_class: { level: @school_class.level, name: @school_class.name, school_id: @school_class.school_id }
    end
  ...
  test "should update school_class" do
    put :update, id: @school_class, school_class: { level: @school_class.level, name: @school_class.name, school_id: @school_class.school_id }
    assert_redirected_to school_class_path(assigns(:school_class))
  end
